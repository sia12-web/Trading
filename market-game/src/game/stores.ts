...
export const COURT_SIGNS = [
  { word: 'YESTERDAY', ink: '#e07040', x: 0.08, z: 15.82, wide: 5.05, y: 3.55 },
  { word: 'FIVE-DAY', ink: '#d48848', x: 7.85, z: 15.82, wide: 3.85, y: 1.78 },
  { word: 'FIVE-MONTH', ink: '#6ab0c4', x: -7.25, z: 15.82, wide: 4.45, y: 1.78 },
  { word: 'YARD', ink: '#d48848', x: 15.82, z: 3.15, wide: 2.95, y: 1.78 },
] as const
