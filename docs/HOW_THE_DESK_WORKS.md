...
4. **5-month anchored VWAP** — typical price `(H+L+C)/3`, standard deviation multipliers 1 / 2 / 3. Style: blue VWAP, green / olive / teal ±σ, fill between ±1σ. The Y-axis stays on **session candles**; far σ bands do not flatten the pane.
