...
assert(LIVE_VOICE_SYSTEM_PROMPT.includes('0.25% desk risk'), 'Leo says 0.25% desk risk')
assert(LIVE_VOICE_SYSTEM_PROMPT.includes('Same 0.25% risk'), 'Leo says same 0.25% for manual')
