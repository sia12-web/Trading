...
const tradeScenarios = [
    {
        ...
        entryRationale: 'Asia Session (18:00-03:00 Montreal time) compression range was 62 pts (<80 pts threshold). Buy Stop triggered at Asia High + 20 pts (52,450).',
    ...
    },
    {
        ...
        riskRewardRatio: '1.50 R',
        outcome: 'WIN' as const,
        entryRationale: 'Dow Asia Range < 80 pts compression (55 pts). Buy stop triggered at 03:00 AM Montreal time at 53,410.',
